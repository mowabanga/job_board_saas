        ...
        <div className="flex flex-col gap-6">
            <Card>
                <CardHeader className="text-center">
                    ...
                    <CardDescription>Login to your Google or Github account to continue</CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="flex flex-col gap-4">
                        ...
                        {/* Google Login -  Remember to implement this */}
                        <form action="">
                            <GeneralSubmitButton 
            ...
            <div className="text-sm text-muted-foreground text-center text-balance">
                By clicking continue, you agree to our <Link href="/terms">terms and services</Link> and <Link href="/privacy">privacy policy</Link>.
            </div>
        </div>
    )
}